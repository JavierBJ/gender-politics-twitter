...
if __name__=='__main__':
    ...
    parser.add_argument('-t', '--notweets', action='store_true', help='do not download original tweets by politicians')
    parser.add_argument('-m', '--nomentions', action='store_true', help='do not download mentions to politicians')
    parser.add_argument('-r', '--noreplies', action='store_true', help='do not download replies to politicians')
    ...
    dump_tweets.dump(not args.notweets, not args.nomentions, not args.noreplies, args.numfile, args.limit, args.since)
