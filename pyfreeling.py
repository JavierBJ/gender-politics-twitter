...
class parse_tree(TreeOfNode):
    ...
    __swig_getmethods__["get_head_word"] = lambda x: _pyfreeling.parse_tree_get_head_word
    if _newclass:
        get_head_word = staticmethod(_pyfreeling.parse_tree_get_head_word)
    __swig_getmethods__["get_head_position"] = lambda x: _pyfreeling.parse_tree_get_head_position
    if _newclass:
        get_head_position = staticmethod(_pyfreeling.parse_tree_get_head_position)
    __swig_getmethods__["C_commands"] = lambda x: _pyfreeling.parse_tree_C_commands
    if _newclass:
...
class dep_tree(TreeOfDepnode):
    ...
    __swig_getmethods__["get_first_word"] = lambda x: _pyfreeling.dep_tree_get_first_word
    if _newclass:
        get_first_word = staticmethod(_pyfreeling.dep_tree_get_first_word)
    __swig_getmethods__["get_last_word"] = lambda x: _pyfreeling.dep_tree_get_last_word
    if _newclass:
...
_pyfreeling.ENTITY_swigconstant(_pyfreeling)
ENTITY = _pyfreeling.ENTITY

_pyfreeling.WORD_swigconstant(_pyfreeling)
...
_pyfreeling.TEXT_swigconstant(_pyfreeling)
TEXT = _pyfreeling.TEXT

_pyfreeling.IDENT_swigconstant(_pyfreeling)
IDENT = _pyfreeling.IDENT

_pyfreeling.TOKEN_swigconstant(_pyfreeling)
TOKEN = _pyfreeling.TOKEN

_pyfreeling.SPLITTED_swigconstant(_pyfreeling)
SPLITTED = _pyfreeling.SPLITTED

_pyfreeling.MORFO_swigconstant(_pyfreeling)
MORFO = _pyfreeling.MORFO

_pyfreeling.TAGGED_swigconstant(_pyfreeling)
TAGGED = _pyfreeling.TAGGED

_pyfreeling.SENSES_swigconstant(_pyfreeling)
SENSES = _pyfreeling.SENSES

_pyfreeling.SHALLOW_swigconstant(_pyfreeling)
SHALLOW = _pyfreeling.SHALLOW

_pyfreeling.PARSED_swigconstant(_pyfreeling)
PARSED = _pyfreeling.PARSED

_pyfreeling.DEP_swigconstant(_pyfreeling)
DEP = _pyfreeling.DEP

_pyfreeling.COREF_swigconstant(_pyfreeling)
COREF = _pyfreeling.COREF

_pyfreeling.SEMGRAPH_swigconstant(_pyfreeling)
SEMGRAPH = _pyfreeling.SEMGRAPH

_pyfreeling.NO_TAGGER_swigconstant(_pyfreeling)
NO_TAGGER = _pyfreeling.NO_TAGGER

_pyfreeling.HMM_swigconstant(_pyfreeling)
HMM = _pyfreeling.HMM

_pyfreeling.RELAX_swigconstant(_pyfreeling)
RELAX = _pyfreeling.RELAX

_pyfreeling.NO_DEP_swigconstant(_pyfreeling)
NO_DEP = _pyfreeling.NO_DEP

_pyfreeling.TXALA_swigconstant(_pyfreeling)
TXALA = _pyfreeling.TXALA

_pyfreeling.TREELER_swigconstant(_pyfreeling)
TREELER = _pyfreeling.TREELER

_pyfreeling.NO_WSD_swigconstant(_pyfreeling)
NO_WSD = _pyfreeling.NO_WSD

_pyfreeling.ALL_swigconstant(_pyfreeling)
ALL = _pyfreeling.ALL

_pyfreeling.MFS_swigconstant(_pyfreeling)
MFS = _pyfreeling.MFS

_pyfreeling.UKB_swigconstant(_pyfreeling)
UKB = _pyfreeling.UKB

_pyfreeling.NO_FORCE_swigconstant(_pyfreeling)
NO_FORCE = _pyfreeling.NO_FORCE

_pyfreeling.TAGGER_swigconstant(_pyfreeling)
TAGGER = _pyfreeling.TAGGER

_pyfreeling.RETOK_swigconstant(_pyfreeling)
...
class util(_object):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["init_locale"] = lambda x: _pyfreeling.util_init_locale
    if _newclass:
        init_locale = staticmethod(_pyfreeling.util_init_locale)
    __swig_getmethods__["wstring2int"] = lambda x: _pyfreeling.util_wstring2int
    if _newclass:
        wstring2int = staticmethod(_pyfreeling.util_wstring2int)
    __swig_getmethods__["int2wstring"] = lambda x: _pyfreeling.util_int2wstring
    if _newclass:
        int2wstring = staticmethod(_pyfreeling.util_int2wstring)
    __swig_getmethods__["wstring2double"] = lambda x: _pyfreeling.util_wstring2double
    if _newclass:
        wstring2double = staticmethod(_pyfreeling.util_wstring2double)
    __swig_getmethods__["double2wstring"] = lambda x: _pyfreeling.util_double2wstring
    if _newclass:
        double2wstring = staticmethod(_pyfreeling.util_double2wstring)
    __swig_getmethods__["wstring2longdouble"] = lambda x: _pyfreeling.util_wstring2longdouble
    if _newclass:
        wstring2longdouble = staticmethod(_pyfreeling.util_wstring2longdouble)
    __swig_getmethods__["longdouble2wstring"] = lambda x: _pyfreeling.util_longdouble2wstring
    if _newclass:
        longdouble2wstring = staticmethod(_pyfreeling.util_longdouble2wstring)
    __swig_getmethods__["vector2wstring"] = lambda x: _pyfreeling.util_vector2wstring
    if _newclass:
        vector2wstring = staticmethod(_pyfreeling.util_vector2wstring)
    __swig_getmethods__["list2wstring"] = lambda x: _pyfreeling.util_list2wstring
    if _newclass:
        list2wstring = staticmethod(_pyfreeling.util_list2wstring)
    __swig_getmethods__["pairlist2wstring"] = lambda x: _pyfreeling.util_pairlist2wstring
    if _newclass:
        pairlist2wstring = staticmethod(_pyfreeling.util_pairlist2wstring)
    __swig_getmethods__["wstring2list"] = lambda x: _pyfreeling.util_wstring2list
    if _newclass:
        wstring2list = staticmethod(_pyfreeling.util_wstring2list)
    __swig_getmethods__["wstring2vector"] = lambda x: _pyfreeling.util_wstring2vector
    if _newclass:
        wstring2vector = staticmethod(_pyfreeling.util_wstring2vector)
    __swig_getmethods__["capitalization"] = lambda x: _pyfreeling.util_capitalization
    if _newclass:
        capitalization = staticmethod(_pyfreeling.util_capitalization)
    __swig_getmethods__["capitalize"] = lambda x: _pyfreeling.util_capitalize
    if _newclass:
        capitalize = staticmethod(_pyfreeling.util_capitalize)
    __swig_getmethods__["lowercase"] = lambda x: _pyfreeling.util_lowercase
    if _newclass:
        lowercase = staticmethod(_pyfreeling.util_lowercase)
    __swig_getmethods__["uppercase"] = lambda x: _pyfreeling.util_uppercase
    if _newclass:
