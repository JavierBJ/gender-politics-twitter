...
#            model = LogisticRegression(class_weight='balanced', solver='liblinear', penalty='l1', C=c_reg)
            ...
            print('Experiment: Extractor =', extname, 'KeepWordsRank =', kwr ,'Naive Bayes Type  =', nb_name, '...')
            det.describe()
...
print('Best experiment: Extractor =', best_ext, 'KeepWordsRank =', best_kwr ,'Naive Bayes Type =', best_nb)
print('Test scores')
