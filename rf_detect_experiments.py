...
folds = 10
kwrs = [5000]
mfs = ['auto', 0.1, 0.2, 0.5, 0.7, 0.9, None]
leafs = [1, 2, 5, 10]
exts = ['tfidfchars']
...
#                model = SVC(class_weight='balanced', C=c_reg)
                ...
                print('Experiment: Extractor =', extname, 'KeepWordsRank =', kwr ,'MaxFeatures =', mf, 'Leaf =', lf, '...')
                det.describe()
...
print('Best experiment: Extractor =', best_ext, 'KeepWordsRank =', best_kwr ,'MaxFeatures =', best_mf, 'Leaf =', best_lf)
print('Test scores')
